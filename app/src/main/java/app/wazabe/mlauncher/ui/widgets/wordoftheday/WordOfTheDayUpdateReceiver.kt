package app.wazabe.mlauncher.ui.widgets.wordoftheday
...
import app.wazabe.mlauncher.ui.widgets.wordoftheday.WordOfTheDayWidget.Companion.updateWidgets
...
class WordOfTheDayUpdateReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "app.wazabe.mlauncher.ui.widgets.wordofday.UPDATE_WIDGET") {
